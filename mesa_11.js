...
function inverter1(array=[]){
    const arrayInvertido = [i = 0]
    arrayInvertido[i++] = array.slice(0).reverse()
    console.log(arrayInvertido)
}
const arrayInvertido = ['banana1', 'banana2', 'banana3']
const elementosInvertidos = arrayInvertido.pop
inverter1(arrayInvertido);
...
function Maiuscula(){
    ...
    const uppercased = filmes.toString().toUpperCase();
